...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param s1 first part of this Silly instance's name.
     * @param s2 second part of this Silly instance's name.
     */
    public Silly(String s1, String s2) {this(s1+s2);}
    ...
    public static void main(String[] args) {
         ...
         */
        x.countStatic(); // return 0, +1 =1
        y.countStatic(); // return 1, +1=2
        x.countStatic(); // return 2, +1=3
        x.countStatic(); // return 3, +1=4
